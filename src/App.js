...
const LoggedInApp = ({ db, auth, user }) => {
    ...
    const [changelogItems, setChangelogItems] = useState([
        {
            id: 'v1.4.0',
            version: '1.4.0',
            timestamp: '2025-07-11T14:00:00.000Z',
            changes: [
                {type: "New Feature", description: "Implemented Collaborative Workspaces for full team edit access."},
                {type: "Improvement", description: "Data (snapshots, experiments, settings) is now scoped to the active workspace."},
                {type: "New Feature", description: "Added Team Management modal to invite users to a workspace via email."},
            ]
        },
    ]);
    ...
    return (
        <>
            ...
            {/* Other Modals (Settings, Changelog) can be added here */}
